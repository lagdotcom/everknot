...
const animationData: AnimationData<Animation, Sprite, Event, Flag> = {
  ...
  dodge: {
    loop: 3,
    frames: [
      { sprite: "dodge1", time: 80 },
      { sprite: "dodge2", time: 80 },
      { sprite: "dodge3", time: 80 },
      { sprite: "dodge4", time: 80 },
      { sprite: "dodge5", time: 80 },
    ],
  },
  dodge_end: {
    finishEvent: "dodge",
    frames: [
      { sprite: "dodge6", time: 80 },
      { sprite: "dodge7", time: 80 },
      { sprite: "dodge8", time: 80 },
      { sprite: "dodge9", time: 80 },
      { sprite: "dodge10", time: 80 },
    ],
  },
  hurt: {
    finishEvent: "hurt",
    frames: [
      { sprite: "hurt1", time: 80 },
      { sprite: "hurt2", time: 80 },
      { sprite: "hurt3", time: 80 },
      { sprite: "hurt4", time: 80 },
      { sprite: "hurt5", time: 80 },
      { sprite: "hurt6", time: 80 },
    ],
  },
  death: {
    finishEvent: "death",
    frames: [
      { sprite: "death1", time: 80 },
      { sprite: "death2", time: 80 },
      { sprite: "death3", time: 80 },
      { sprite: "death4", time: 80 },
      { sprite: "death5", time: 80 },
      { sprite: "death6", time: 80 },
      { sprite: "death7", time: 80 },
      { sprite: "death8", time: 80 },
      { sprite: "death9", time: 80 },
      { sprite: "death10", time: 80 },
      { sprite: "death11", time: 80 },
      { sprite: "death12", time: 80 },
      { sprite: "death13", time: 80 },
      { sprite: "death14", time: 80 },
      { sprite: "death15", time: 80 },
      { sprite: "death16", time: 80 },
    ],
  },
};

export const animator = new Animator(spritesheet, "idle", animationData);
